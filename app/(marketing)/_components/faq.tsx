...
const faq = [
  {
    question: "برای استفاده از استادیو چه پیش‌نیاز فنی لازم است؟",
    answer:
      "استادیو یک سرویس ابری است و روی مرورگرهای به‌روز موبایل، تبلت و رایانه اجرا می‌شود. برای استفاده روزانه فقط اینترنت پایدار و یک حساب کاربری مدیر لازم است؛ نصب نرم‌افزار جداگانه یا سرور محلی نیاز نیست.",
  },
  {
    question: "تعرفه‌ها و شرایط پرداخت چگونه است؟",
    answer:
      "پلن پایه تا ۱۵ صندلی ۸۹۰٬۰۰۰ است. پلن حرفه‌ای با مبلغ ۱٬۴۹۰٬۰۰۰ تومان برای هر ماه ارائه می‌شود و صندلی نامحدود، مدیریت کارکنان و امکانات حرفه‌ای را فعال می‌کند. جزئیات لغو و بازگشت وجه در صفحه سیاست بازگشت وجه آمده است.",
  },
  {

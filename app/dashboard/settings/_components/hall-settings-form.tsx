...
import { updateStudyHallSettings } from "@/app/actions/auth";
      ...
      <CardContent className="space-y-6 pt-6">
        ...
        <div className="rounded-3xl border bg-muted/20 p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-bold">تنظیمات اعلان‌های سالن</h3>
              <p className="mt-1 text-sm leading-6 text-muted-foreground">
                تنظیمات اعلان‌های سالن (یادآوری تمدید و انقضا) به‌زودی در نسخه‌های آینده در دسترس خواهد بود.
              </p>
            </div>
          </div>
        </div>

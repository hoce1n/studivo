...
const policies = [
  ...
  ["ارتقا و کاهش پلن", "ارتقا از پلن پایه به حرفه‌ای پس از پرداخت ۸۹۰٬۰۰۰ تومان برای ماه جاری فعال می‌شود. کاهش از پلن حرفه‌ای به پایه از دوره بعد اعمال می‌شود تا اختلالی در عملیات جاری سالن ایجاد نشود."],

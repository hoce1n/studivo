...
const faq = [
  ...
  },
  {
    ...
    answer:
      "پلن پایه تا ۱۵ صندلی رایگان است. پلن حرفه‌ای با مبلغ ۸۹۰٬۰۰۰ تومان برای هر ماه ارائه می‌شود و صندلی نامحدود، مدیریت کارکنان و امکانات حرفه‌ای را فعال می‌کند. جزئیات لغو و بازگشت وجه در صفحه سیاست بازگشت وجه آمده است.",
  },
  {
